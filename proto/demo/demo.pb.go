...
func init() {
	proto.RegisterType((*DemoRequest)(nil), "proto.DemoRequest")
	proto.RegisterType((*DemoReply)(nil), "proto.DemoReply")
}
...
var fileDescriptor_ca53982754088a9d = []byte{
	...
	0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x05, 0x53, 0x4a, 0x8a, 0x5c, 0xdc, 0x2e, 0xa9,
	0xb9, 0xf9, 0x41, 0xa9, 0x85, 0xa5, 0xa9, 0xc5, 0x25, 0x42, 0x42, 0x5c, 0x2c, 0x79, 0x89, 0xb9,
	...
	0x6b, 0x64, 0xc9, 0xc5, 0x02, 0x52, 0x26, 0x64, 0xc8, 0xc5, 0x1e, 0x54, 0x90, 0x0c, 0x66, 0x0a,
	0x41, 0xec, 0xd2, 0x43, 0xb2, 0x41, 0x4a, 0x00, 0x45, 0xac, 0x20, 0xa7, 0x52, 0x89, 0x21, 0x89,
	0x0d, 0x2c, 0x64, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x69, 0x55, 0xf6, 0x72, 0xa0, 0x00, 0x00,
	0x00,
}
...
type DemoClient interface {
	RpcDemo(ctx context.Context, in *DemoRequest, opts ...grpc.CallOption) (*DemoReply, error)
}
...
func (c *demoClient) RpcDemo(ctx context.Context, in *DemoRequest, opts ...grpc.CallOption) (*DemoReply, error) {
	out := new(DemoReply)
	err := c.cc.Invoke(ctx, "/proto.Demo/RpcDemo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DemoServer interface {
	RpcDemo(context.Context, *DemoRequest) (*DemoReply, error)
}
...
func (*UnimplementedDemoServer) RpcDemo(ctx context.Context, req *DemoRequest) (*DemoReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RpcDemo not implemented")
}
...
func _Demo_RpcDemo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DemoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DemoServer).RpcDemo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Demo/RpcDemo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServer).RpcDemo(ctx, req.(*DemoRequest))
	}
